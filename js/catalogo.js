...
let StockVeh
if (!localStorage.getItem("StockVeh")) {
...
console.log("usando valor default")
}
else{
    StockVeh = JSON.parse(localStorage.getItem("StockVeh"));
    console.log("tabla cargada")
   
StockVeh=StockVeh.filter(producto => producto.id) //Añadido por un error previo. Filtra todos los objetos sin ID y los filtra.
  
    localStorage.setItem("StockVeh", JSON.stringify(StockVeh));
  StockVeh.forEach(producto => {console.log(producto.nombre+"ID:"+producto.id)})
}


function renderProductos(lista) {
    if (!contenedor){return;}else{
